...
class CryptoTestCase(test.TestCase):
    ...
    def test_mkreq(self):
        ...
        subject = 'nova'
        ca = 0
        req, pk = self.crypto.mkreq(bits, subject, ca)
        self.assertTrue(req.get_pubkey())
        sub = req.get_subject()
        self.assertEqual('US', sub.C)
        self.assertEqual(subject, sub.CN)
    ...
    def test_mkcacert(self):
        ...
        self.assertEqual('US', issuer.C)
        self.assertEqual(subject, issuer.CN)
        self.assertTrue(pk.get_rsa())
