...
class DiskTestCase(test.TestCase):
    ...
    def test_mkfs(self):
        ...
        self.assertEqual(1, self._execute_count)
    ...
    def test_extend(self):
        ...
        self.assertEqual(3, self._execute_count)
    ...
    def test_extend_ex_execute_e2fsck(self):
        ...
        self.assertRaises(exception.ProcessExecutionError,
                          self.disk.extend,
                          image_path, size)
        self.assertEqual(2, self._execute_count)
    ...
    def test_inject_data_param_tune2fs(self):
        ...
        self.disk.inject_data(image, key, net, metadata,
                              partition, nbd, tune2fs)
        self.assertEqual(4, self._execute_count)
