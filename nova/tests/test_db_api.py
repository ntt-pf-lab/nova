...
class DbApiTestCase(test.TestCase):
    ...
    def test_instance_get_all_by_filters_deleted(self):
        ...
        result = self.db.instance_get_all_by_filters(self.context.elevated(), {})
    ...
    def test_service_get_by_host_and_topic(self):
        ...
        """
        # setup
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'topic': 'compute'})
        
        # test and assert
        result = self.db.api.service_get_by_host_and_topic(self.context, 'host1', 'compute')
    ...
    def test_service_get_by_host_and_topic_database_not_found(self):
        ...
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'topic': 'compute'})
        # test and assert
        result = self.db.api.service_get_by_host_and_topic(self.context, 'host2', 'compute')
        self.assertTrue(result is None)
    ...
    def test_service_get_all_compute_by_host(self):
        ...
        # test and assert
        result = self.db.api.service_get_all_compute_by_host(self.context, 'host1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
        self.assertEqual(1, len(result))
        self.assertEqual(1, result[0].id)
    ...
    def test_service_get_all_compute_by_host_database_not_found(self):
        ...
        """
        # test and assert
        self.assertRaises(exception.ComputeHostNotFound, self.db.api.service_get_all_compute_by_host,
                          self.context, 'host1')
    ...
    def test_service_get_all_compute_sorted(self):
        ...
        # setup
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'topic': 'compute'})
        self.db.api.instance_create(self.context, {'host': 'host1', 'vcpus': 1})
        self.db.api.instance_create(self.context, {'host': 'host1', 'vcpus': 2})
    ...
    def test_service_get_all_network_sorted(self):
        ...
        """
        # setup
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'topic': 'network'})
    ...
    def test_service_get_all_volume_sorted(self):
        ...
        """
        # setup
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'topic': 'volume'})
    ...
    def test_service_get_by_args(self):
        ...
        """
        # setup
        self.db.api.service_create(self.context, {'id': 1, 'host': 'host1', 'binary': 'binary1'})
        
        # test and assert
        result = self.db.api.service_get_by_args(self.context, 'host1', 'binary1')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
        self.assertEqual('host1', result.host)
    ...
    def test_service_get_by_args_database_not_found(self):
        # test and assert
        self.assertRaises(exception.HostBinaryNotFound, self.db.api.service_get_by_args,
    ...
    def test_compute_node_get(self):
        ...
        # setup
        self.db.api.service_create(self.context, {'id': 1})
        self.db.api.compute_node_create(self.context, {'id': 1,
                                                  'service_id': 1,
                                                  'vcpus': 1,
                                                  'memory_mb': 1,
                                                  'local_gb': 1,
    ...
    def test_certificate_create(self):
        ...
        """
        # setup
        certificate_list = self.db.api.certificate_get_all_by_project(self.context, 'project1')
        self.assertEqual(0, len(certificate_list))
        
        # test and assert
        result = self.db.api.certificate_create(self.context, {'id': 1, 'project_id': 'project1'})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_certificate_destroy(self):
        ...
        """
        # setup
        self.db.api.certificate_create(self.context, {'id': 1, 'project_id': 'project1'})
        certificate_list = db.api.certificate_get_all_by_project(self.context, 'project1')
        self.assertEqual(1, len(certificate_list))
    ...
    def test_certificate_get_all_by_project(self):
        ...
        # test and assert
        result = self.db.api.certificate_get_all_by_project(self.context, 'project1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
        self.assertEqual(1, len(result))
        self.assertEqual(1, result[0].id)
    ...
    def test_certificate_get_all_by_user(self):
        ...
        """
        # setup
        self.db.api.certificate_create(self.context, {'id': 1, 'user_id': 'user1'})
    ...
    def test_certificate_get_all_by_user_and_project(self):
        ...
        """
        # setup
        self.db.api.certificate_create(self.context, {'id': 1, 'user_id': 'user1', 'project_id': 'project1'})
        
        # test and assert
        result = self.db.api.certificate_get_all_by_user_and_project(self.context,
                                                                'user1',
                                                                'project1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
    ...
    def test_floating_ip_allocate_address(self):
        ...
        """
        # setup
        self.db.api.floating_ip_create(self.context, {'id': 1, 'address': '1.0.0.0'})
        
        # test and assert
        result = self.db.api.floating_ip_allocate_address(self.context, 'project1')
        self.assertTrue(result is not None)
    ...
    def test_floating_ip_create(self):
        ...
        """
        # test and assert
        result = self.db.api.floating_ip_create(self.context, {'id': 1, 'address': '1.0.0.0'})
        self.assertTrue(result is not None)
        self.assertEqual('1.0.0.0', result)
    ...
    def test_floating_ip_count_by_project(self):
        ...
        """
        # setup
        self.db.api.floating_ip_create(self.context, {'id': 1, 'project_id': 'project1'})
        
        # test and assert
        result = self.db.api.floating_ip_count_by_project(self.context, 'project1')
        self.assertTrue(result is not None)
    ...
    def test_floating_ip_fixed_ip_associate(self):
        ...
        # test and assert
        result = self.db.api.floating_ip_fixed_ip_associate(self.context, '1.0.0.0', '10.1.1.1', 'localhost')
        self.assertTrue(result is None)
    ...
    def test_floating_ip_get_all_database_not_found(self):
        # test and assert
        self.assertRaises(exception.NoFloatingIpsDefined, db.api.floating_ip_get_all,
                          self.context)
    ...
    def test_floating_ip_get_all_by_project(self):
        ...
        # test and assert
        result = self.db.api.floating_ip_get_all_by_project(self.context, 'project1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
        self.assertEqual(1, len(result))
        self.assertEqual(1, result[0].id)
    ...
    def test_floating_ip_get_by_address(self):
        ...
        # test and assert
        result = self.db.api.floating_ip_get_by_address(self.context, '1.0.0.0')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_floating_ip_get_by_address_database_not_found(self):
        # test and assert
        self.assertRaises(exception.FloatingIpNotFoundForAddress, db.api.floating_ip_get_by_address,
                          self.context, '1.0.0.0')
    ...
    def test_floating_ip_update(self):
        ...
        # test and assert
        self.db.api.floating_ip_update(self.context, '1.0.0.0', {'host': 'host1'})
    ...
    def test_floating_ip_update_database_not_found(self):
        # test and assert
        self.assertRaises(exception.FloatingIpNotFoundForAddress, db.api.floating_ip_update,
    ...
    def test_floating_ip_set_auto_assigned_database_not_found(self):
        # test and assert
        self.assertRaises(exception.FloatingIpNotFoundForAddress, db.api.floating_ip_set_auto_assigned,
                          self.context, '1.0.0.0')
    ...
    def test_migration_update(self):
        ...
        # test and assert
        result = self.db.api.migration_update(self.context, 1, {'source_compute': 'source_compute1'})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_migration_get_by_instance_and_status(self):
        ...
        # test and assert
        result = self.db.api.migration_get_by_instance_and_status(self.context, 'instance_uuid1', 'status1')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_fixed_ip_associate(self):
        ...
        # test and assert
        result = self.db.api.fixed_ip_associate(self.context, '10.1.1.1', 1, 100)
        self.assertTrue(result is not None)
        
        fixed_ip = self.db.api.fixed_ip_get_by_address(self.context, '10.1.1.1')
        self.assertTrue(result is not None)
    ...
    def test_fixed_ip_associate_pool(self):
        ...
        # test and assert
        result = self.db.api.fixed_ip_associate_pool(self.context, 100, 1, 'host1')
        self.assertTrue(result is not None)
        self.assertEqual('10.1.1.1', result)
    ...
    def test_fixed_ip_disassociate(self):
        ...
        # setup
        self.db.api.instance_create(self.context, {'id': 1})
        self.db.api.fixed_ip_create(self.context, {'address': '10.1.1.1', 'instance_id': 1})
    ...
    def test_fixed_ip_disassociate_all_by_timeout(self):
        ...
        """
        # setup
        self.db.api.network_create_safe(self.context, {'id': 100, 'host': 'host1'})
        self.db.api.instance_create(self.context, {'id': 1})
        self.db.api.fixed_ip_create(self.context, {'address': '10.1.1.1',
                                              'network_id': 100,
                                              'instance_id': 1,
        ...
        # test and assert
        self.db.api.fixed_ip_disassociate_all_by_timeout(self.context,
                                                             'host1',
    ...
    def test_fixed_ip_disassociate_all_by_timeout_database_not_found(self):
        ...
        """
        # test and assert
        result = self.db.api.fixed_ip_disassociate_all_by_timeout(self.context,
                                                             'host1',
                                                             datetime.datetime(2011, 1, 1))
        self.assertTrue(result is not None)
    ...
    def test_fixed_ip_get_by_network_host(self):
        ...
        """
        # setup
        self.db.api.fixed_ip_create(self.context, {'network_id': 100, 'host': 'host1'})
        
        # test and assert
        result = self.db.api.fixed_ip_get_by_network_host(self.context, 100, 'host1')
        self.assertTrue(result is not None)
    ...
    def test_fixed_ip_get_network(self):
        ...
        # setup
        self.db.api.network_create_safe(self.context, {'id': 100})
        self.db.api.fixed_ip_create(self.context, {'address': '10.1.1.1', 'network_id': 100})
    ...
    def test_fixed_ip_update(self):
        ...
        # test and assert
        self.db.api.fixed_ip_update(self.context, '10.1.1.1', {'host': 'host1'})
    ...
    def test_virtual_interface_create(self):
        ...
        """
        # test and assert
        result = self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_virtual_interface_create_database_duplicate(self):
        raise SkipTest("DBError occured")
        # setup
        self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1, 'address': '10.1.1.1'})
        
        # test and assert
        self.assertRaises(exception.Duplicate,
                          self.db.api.virtual_interface_create,
                          self.context, {'id': 1, 'instance_id': 1, 'address': '10.1.1.1'})
    ...
    def test_virtual_interface_update(self):
        ...
        """
        # setup
        self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1})
        
        # test and assert
        self.db.api.virtual_interface_update(self.context, 1, {'uuid': 'uuid1'})
    ...
    def test_virtual_interface_get_by_address(self):
        ...
        # test and assert
        result = self.db.api.virtual_interface_get_by_address(self.context, '10.1.1.1')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
        self.assertEqual('10.1.1.1', result.address)
    ...
    def test_virtual_interface_get_by_uuid(self):
        ...
        """
        # setup
        self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1, 'uuid': 'uuid1'})
        
        # test and assert
        result = self.db.api.virtual_interface_get_by_uuid(self.context, 'uuid1')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_virtual_interface_get_by_fixed_ip(self):
        ...
        # FIXME InvalidRequestError: Entity 'Mapper|VirtualInterface|virtual_interfaces' has no property 'fixed_ip_id'
        """
        raise SkipTest("FIXME InvalidRequestError: Entity 'Mapper|VirtualInterface|virtual_interfaces' has no property 'fixed_ip_id'")
        # setup
        self.db.api.network_create_safe(self.context, {'id': 100})
        self.db.api.fixed_ip_create(self.context, {'address': '10.1.1.1', 'network_id': 100})
        self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1, 'network_id': 100})
        
        # test and assert
        result = self.db.api.virtual_interface_get_by_fixed_ip(self.context, '10.1.1.1')
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_virtual_interface_get_by_fixed_ip_database_not_found(self):
        ...
        # test and assert
        # FIXME InvalidRequestError: Entity 'Mapper|VirtualInterface|virtual_interfaces' has no property 'fixed_ip_id'
        result = db.api.virtual_interface_get_by_fixed_ip(self.context, '2.0.0.0')
        self.assertTrue(result is None)
    ...
    def test_virtual_interface_get_by_instance_and_network(self):
        ...
        """
        # setup
        self.db.api.virtual_interface_create(self.context, {'id': 1, 'instance_id': 1, 'network_id': 1})
        
        # test and assert
        result = self.db.api.virtual_interface_get_by_instance_and_network(self.context, 1, 1)
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
        self.assertEqual(1, result.instance_id)
    ...
    def test_virtual_interface_delete_database_not_found(self):
        raise SkipTest("UnmappedInstanceError: Class '__builtin__.NoneType' is not mapped")
        # test and assert
        # FIXME VirtualInterfaceNotFound does not exist.
        self.assertRaises(exception.NotFound,
    ...
    def test_virtual_interface_delete_by_instance(self):
        ...
        # test and assert
        result = self.db.api.virtual_interface_delete_by_instance(self.context, 1)
        self.assertTrue(result is None)
    ...
    def test_instance_data_get_for_project(self):
        ...
        # test and assert
        result = self.db.api.instance_data_get_for_project(self.context, 'project1')
        self.assertTrue(result is not None)
    ...
    def test_instance_get_by_uuid_database_not_found(self):
        # test and assert
        self.assertRaises(exception.InstanceNotFound, self.db.api.instance_get_by_uuid,
                          self.context, 'uuid1')
    ...
    def test_instance_get_active_by_window(self):
        ...
        # test and assert
        result = self.db.api.instance_get_active_by_window(self.context,
    ...
    def test_instance_get_active_by_window_joined(self):
        ...
        # test and assert
        result = self.db.api.instance_get_active_by_window_joined(self.context,
                                                      datetime.datetime(2011, 1, 2),
                                                      datetime.datetime(2011, 1, 3),
                                                      'project1')
        self.assertTrue(result is not None)
    ...
    def test_instance_get_all_by_user(self):
        ...
        """
        # setup
        self.db.api.instance_create(self.context, {'id': 1, 'user_id': 'user1'})
    ...
    def test_instance_get_all_by_project(self):
        ...
        """
        # setup
        self.db.api.instance_create(self.context, {'id': 1, 'project_id': 'project1'})
        
        # test and assert
        result = self.db.api.instance_get_all_by_project(self.context, 'project1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
        self.assertEqual(1, len(result))
        self.assertEqual(1, result[0].id)
    ...
    def test_instance_get_all_by_reservation(self):
        ...
        """
        # setup
        self.db.api.instance_create(self.context, {'id': 1, 'reservation_id': 'reservation1'})
        
        # test and assert
        result = db.api.instance_get_all_by_reservation(self.context, 'reservation1')
        self.assertTrue(result is not None)
        self.assertTrue(isinstance(result, list))
        self.assertEqual(1, len(result))
        self.assertEqual(1, result[0].id)
    ...
    def test_instance_get_all_by_reservation_database_not_found(self):
        ...
        self.db.api.instance_create(self.context, {'id': 1, 'reservation_id': 'reservation1'})
        # test and assert
        result = self.db.api.instance_get_all_by_reservation(self.context, 'reservation2')
        self.assertTrue(result is not None)
        self.assertEqual([], result)
    ...
    def test_instance_get_by_fixed_ipv6(self):
        ...
        db.api.IMPL.instance_get_by_fixed_ipv6(mox.IgnoreArg(), mox.IgnoreArg()).\
                AndReturn({'id': 1})
        self.mox.ReplayAll()
        
        # setup
        db.api.instance_create(self.context, {'id': 1})
        db.api.virtual_interface_create(self.context, {'id': 1,
                                                       'instance_id': 1,
                                                       'address': '02:00:00:00:00:00'})
        # test and assert
        result = db.api.instance_get_by_fixed_ipv6(self.context, '3:0:0:0:0:0:0:0')
        self.assertTrue(result is not None)
        self.assertEqual(1, result['id'])
    ...
    def test_instance_get_fixed_addresses_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.InstanceNotFound, db.api.instance_get_fixed_addresses,
                          self.context, 2)
    ...
    def test_instance_get_fixed_addresses_v6(self):
        ...
        self.mox.StubOutWithMock(db.api.IMPL, 'virtual_interface_create')
        self.db.api.IMPL.virtual_interface_create(mox.IgnoreArg(), mox.IgnoreArg())
        self.mox.StubOutWithMock(db.api.IMPL, 'instance_get_fixed_addresses_v6')
        self.db.api.IMPL.instance_get_fixed_addresses_v6(mox.IgnoreArg(), mox.IgnoreArg()).\
                AndReturn(['::ff:ff00:0'])
        self.mox.ReplayAll()
        
        # setup
        self.db.api.instance_create(self.context, {'id': 1})
        self.db.api.network_create_safe(self.context, {'cidr_v6': '3.0.0.0/29'})
        self.db.api.virtual_interface_create(self.context, {'id': 1,
                                                            'network_id': 1,
                                                            'instance_id': 1,
                                                            'address': '02:00:00:00:00:00'})
    ...
    def test_instance_get_fixed_addresses_v6_database_not_found(self):
        ...
        self.db.api.IMPL.instance_create(mox.IgnoreArg(), mox.IgnoreArg())
        self.mox.StubOutWithMock(self.db.api.IMPL, 'instance_get_fixed_addresses_v6')
        self.db.api.IMPL.instance_get_fixed_addresses_v6(mox.IgnoreArg(), mox.IgnoreArg()).\
                AndReturn([])
        self.mox.ReplayAll()
    ...
    def test_instance_get_floating_address(self):
        ...
        # setup
        self.db.api.instance_create(self.context, {'id': 1})
        self.db.api.fixed_ip_create(self.context, {'id': 100, 'instance_id': 1})
        self.db.api.floating_ip_create(self.context, {'id': 1,
                                                 'fixed_ip_id': 100,
                                                 'address': '1.0.0.0'})
    ...
    def test_instance_get_floating_address_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.FixedIpNotFoundForInstance, db.api.instance_get_floating_address,
                          self.context, 2)
    ...
    def test_instance_update(self):
        ...
        # test and assert
        result = self.db.api.instance_update(self.context, 1, {'host': 'host1'})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_instance_add_security_group(self):
        ...
        security_group_list = db.api.security_group_get_by_instance(self.context, 1)
    ...
    def test_instance_remove_security_group(self):
        ...
        # test and assert
        result = self.db.api.instance_remove_security_group(self.context, 1, 1)
        self.assertTrue(result is None)
        
        security_group_list = self.db.api.security_group_get_by_instance(self.context, 1)
    ...
    def test_instance_remove_security_group_database_not_found(self):
        ...
        # test and assert
        result = self.db.api.instance_remove_security_group(self.context, 1, 2)
        self.assertTrue(result is None)
    ...
    def test_instance_action_create(self):
        ...
        """
        # test and assert
        result = self.db.api.instance_action_create(self.context, {'id': 1, 'instance_id': 1})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
        
        instance_action_list = self.db.api.instance_get_actions(self.context, result.id)
    ...
    def test_instance_get_actions(self):
        ...
        """
        # setup
        self.db.api.instance_action_create(self.context, {'id': 1, 'instance_id': 1})
    ...
    def test_key_pair_create(self):
        ...
        """
        # test and assert
        result = self.db.api.key_pair_create(self.context, {'id': 1,
                                                       'user_id': 'user1',
                                                       'name': 'name1'})
        self.assertTrue(result is not None)
        self.assertEqual(1, result.id)
    ...
    def test_key_pair_destroy_database_not_found(self):
        ...
        self.db.api.key_pair_create(self.context, {'id': 1,
                                              ...
                                              'name': 'name1'})
        # test and assert
        self.assertRaises(exception.KeypairNotFound, self.db.api.key_pair_destroy,
    ...
    def test_key_pair_destroy_all_by_user(self):
        ...
        # test and assert
        result = self.db.api.key_pair_destroy_all_by_user(self.context, 'user1')
        self.assertTrue(result is None)
        
        # test and assert
        self.assertRaises(exception.KeypairNotFound, self.db.api.key_pair_get,
                          self.context, 'user1', 'name1')
    ...
    def test_key_pair_get_all_by_user(self):
        ...
        """
        # setup
        self.db.api.key_pair_create(self.context, {'id': 1, 'user_id': 'user1'})
    ...
    def test_network_associate_with_force(self):
        raise SkipTest("network record should be store when associate called")
        # setup
        self.db.api.network_create_safe(self.context, {'id': 100, 'project_id':'other_project'})
        
        # test and assert
        result = self.db.api.network_associate(self.context, 'project1', True)
        self.assertEqual('project1', result.project_id)
        network = self.db.api.network_get(self.context, 100)
        self.assertEqual('project1', network.project_id)
    ...
    def test_network_associate_with_no_more_networks(self):
        ...
        for nw in networks:
            self.db.api.network_update(self.context, nw.id, {'project_id': 'project'})
        # test and assert
    ...
    def test_network_count_allocated_ips(self):
        ...
        """
        # setup
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id': 100, 'allocated':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id': 100, 'allocated':False})
    ...
    def test_network_count_available_ips(self):
        ...
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id': 100, 'allocated':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id': 100, 'allocated':False})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.3', 'network_id': 100, 'allocated':False})
    ...
    def test_network_count_available_ips_database_not_found(self):
        ...
        # setup
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id': 100, 'allocated':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id': 100, 'allocated':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.3', 'network_id': 100, 'allocated':True})
    ...
    def test_network_count_reserved_ips(self):
        ...
        """
        # setup
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id': 100, 'reserved':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id': 100, 'reserved':False})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.3', 'network_id': 100, 'reserved':False})
    ...
    def test_network_count_reserved_ips_database_not_found(self):
        ...
        # setup
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id': 100, 'reserved':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id': 100, 'reserved':True})
        self.db.api.fixed_ip_create(self.context, {'address':'10.1.1.3', 'network_id': 100, 'reserved':True})
    ...
    def test_network_create_safe_database_duplicate(self):
        ...
        # setup
        self.db.api.network_create_safe(self.context, {'id':100, 'label': 'nw1'})
        # test and assert
        self.db.api.network_create_safe(self.context, {'id':100, 'label': 'nw2'})
        nw = self.db.api.network_get(self.context, 100)
    ...
    def test_network_delete_safe(self):
        ...
        self.assertRaises(exception.NetworkNotFound, self.db.api.network_get
                          , self.context, 100)
    ...
    def test_network_disassociate_all(self):
        ...
        self.db.api.network_create_safe(self.context, {'id':100,
                                                       'project_id': 'project1',
                                                       'host': 'host1'})
        self.db.api.network_create_safe(self.context, {'id':101,
                                                       'project_id': 'project1',
                                                       'host': 'host1'})
        # test and assert
    ...
    def test_network_get_all_database_not_found(self):
        ...
        for nw in nws:
            self.db.api.network_update(self.context, nw.id, {'deleted':True})
        # test and assert
    ...
    def test_network_get_all_by_uuids_with_project_id(self):
        ...
        self.db.api.network_create_safe(self.context, {'id':100,
                                                       ...
                                                       'uuid': 'uuid'})
        # test and assert
        nw = self.db.api.network_get_all_by_uuids(self.context, ['uuid'], 'project1')
        self.assertEqual(100, nw[0].id)
    ...
    def test_network_get_associated_fixed_ips(self):
        # setup
        self.db.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id':100, 'instance_id':1, 'virtual_interface_id':1})
        self.db.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id':100, 'instance_id':2, 'virtual_interface_id':2})
        # test and assert
    ...
    def test_network_get_associated_fixed_ips_database_not_found(self):
        # setup
        self.db.fixed_ip_create(self.context, {'address':'10.1.1.1', 'network_id':100, 'instance_id':1})
        self.db.fixed_ip_create(self.context, {'address':'10.1.1.2', 'network_id':100, 'virtual_interface_id':2})
        # test and assert
        ips = self.db.api.network_get_associated_fixed_ips(self.context, 100)
    ...
    def test_network_get_by_bridge(self):
        # setup
        self.db.network_create_safe(self.context, {'id':100, 'bridge':'br100'})
        self.db.network_create_safe(self.context, {'id':101, 'bridge':'br101'})
        # test and assert
    ...
    def test_network_get_by_uuid(self):
        # setup
        self.db.network_create_safe(self.context, {'id':100, 'uuid':'uuid1'})
        self.db.network_create_safe(self.context, {'id':101, 'uuid':'uuid2'})
        # test and assert
    ...
    def test_network_get_by_cidr(self):
        # setup
        self.db.network_create_safe(self.context, {'id':100, 'cidr':'10.1.0.0'})
        self.db.network_create_safe(self.context, {'id':101, 'cidr':'10.2.0.0'})
        # test and assert
    ...
    def test_network_get_by_instance(self):
        ...
        self.db.fixed_ip_create(self.context, {'network_id':100, 'instance_id':1})
        # test and assert
    ...
    def test_network_get_all_by_host(self):
        ...
        self.db.fixed_ip_create(self.context, {'network_id':100, 'instance_id':1, 'host':'host'})
        # test and assert
    ...
    def test_network_update_database_duplicate(self):
        raise SkipTest("No error happened when update record and duplicate unique column.")
        # setup
        self.db.network_create_safe(self.context, {'id':100, 'cidr':'10.1.1.0'})
        self.db.network_create_safe(self.context, {'id':101, 'cidr':'10.2.1.0'})
        # test and assert
        self.assertRaises(exception.Duplicate,                       self.db.api.network_update,
    ...
    def test_iscsi_target_count_by_host(self):
        # setup
        self.db.api.iscsi_target_create_safe(self.context, {'id':1, 'host':'host'})
        # test and assert
    ...
    def test_auth_token_destroy(self):
        # setup
        self.db.api.auth_token_create(self.context, {"token_hash":"hash", "user_id":"user1"})
        # test and assert
    ...
    def test_auth_token_update(self):
        ...
        self.db.api.auth_token_create(self.context, {"token_hash":"hash", "user_id":"user1"})
        # test and assert
        self.db.api.auth_token_update(self.context, "hash", {"user_id":"user2"})
    ...
    def test_auth_token_create_database_duplicate(self):
        raise SkipTest("DBError: (IntegrityError) column token_hash is not unique")
        # setup
        token = {}
        token['token_hash'] ='hash'
        token['user_id'] = 'user'
    ...
    def test_quota_create_database_duplicate(self):
        """
        when same project, same resource specified, it will be update quota value.
        """
        # setup
        self.db.api.quota_create(self.context, 'project1', 'vcpus', 1)
    ...
    def test_quota_destroy(self):
        ...
        quota = self.db.api.quota_get_all_by_project(self.context, 'project1')
        self.assertFalse(quota.has_key('vcpus'))
        self.assertEqual(10, quota['memory_mb'])
        self.assertEqual(5, quota['disk_gb'])
    ...
    def test_quota_destroy_all_by_project(self):
        ...
        quota = self.db.api.quota_get_all_by_project(self.context, 'project1')
        self.assertFalse(quota.has_key('vcpus'))
        self.assertFalse(quota.has_key('memory_mb'))
        self.assertFalse(quota.has_key('disk_gb'))
    ...
    def test_volume_allocate_shelf_and_blade(self):
        # setup
        self.db.api.export_device_create_safe(self.context, {'shelf_id':1, 'blade_id':1})
        self.db.api.volume_create(self.context, {'id':1, 'size':'1g'})
        # test and assert
        shelf_id, blade_id = self.db.volume_allocate_shelf_and_blade(self.context, 1)
    ...
    def test_volume_allocate_shelf_and_blade_no_more_blades(self):
        # test and assert
        self.assertRaises(db.NoMoreBlades, self.db.volume_allocate_shelf_and_blade,
                          self.context, 1)

    @attr(kind='small')
    def test_volume_allocate_iscsi_target(self):
        # setup
        self.db.api.iscsi_target_create_safe(self.context, {'target_num':1, 'host':'host'})
        self.db.api.volume_create(self.context, {'id':1, 'size':'1g'})
        # test and assert
        target_num = self.db.volume_allocate_iscsi_target(self.context, 1, 'host')
        self.assertEqual(1, target_num)

    @attr(kind='small')
    def test_volume_allocate_iscsi_target_no_more_target(self):
        # test and assert
        self.assertRaises(db.NoMoreTargets, self.db.volume_allocate_iscsi_target,
                          self.context, 1, 'host')
    ...
    def test_volume_create(self):
        ...
        self.assertEqual(FLAGS.storage_availability_zone, volume.availability_zone)
    ...
    def test_volume_create_database_duplicate(self):
        ...
        self.assertRaises(exception.Duplicate, self.db.api.volume_create,
                          self.context, vol)

    @attr(kind='small')
    def test_volume_data_get_for_project(self):
        # setup
        self.db.api.volume_create(self.context, {'size':'1g', 'project_id':'project1'})
        self.db.api.volume_create(self.context, {'size':'2g', 'project_id':'project1'})
        self.db.api.volume_create(self.context, {'size':'3g', 'project_id':'project1'})
        # test and assert
        count, sum = self.db.api.volume_data_get_for_project(self.context, 'project1')
    ...
    def test_volume_destroy(self):
        """
        destroy means remove all volume related records. metadata and iscsi/aoe.
        looks very dangerous.is vsa? zadara? if command failed?
        """
        # setup
        vol = {}
        vol['id'] = 1
        ...
        self.assertRaises(exception.VolumeNotFound, self.db.volume_metadata_get,
                          self.context, 1)
        self.assertRaises(exception.VolumeNotFound, self.db.volume_get,
                          self.context, 1)
    ...
    def test_volume_get_database_not_found(self):
        ...
        self.assertRaises(exception.VolumeNotFound, self.db.api.volume_get,
                          self.context, 2)
    ...
    def test_volume_get_all_by_project(self):
        ...
        volumes = self.db.api.volume_get_all_by_project(self.context, 'fake')
        volume = volumes[0]
        self.assertEqual('1g', volume.size)
        self.assertEqual(None, volume.snapshot_id)
        self.assertEqual('fake', volume.user_id)
    ...
    def test_volume_get_all_by_project_database_not_found(self):
        ...
        volumes = self.db.api.volume_get_all_by_project(self.context, 'fake2')
        self.assertEqual([], volumes)
    ...
    def test_volume_get_shelf_and_blade(self):
        # setup
        self.db.api.export_device_create_safe(self.context, {'volume_id':1, 'shelf_id':1, 'blade_id':1})
        # test and assert
        shelf_id, blade_id = self.db.api.volume_get_shelf_and_blade(self.context, 1)
        self.assertEqual(1, shelf_id)
        self.assertEqual(1, blade_id)
    ...
    def test_volume_get_shelf_and_blade_database_not_found(self):
        ...
        self.db.api.export_device_create_safe(self.context, {'volume_id':1, 'shelf_id':1, 'blade_id':1})
        # test and assert
        self.assertRaises(exception.ExportDeviceNotFoundForVolume, self.db.api.volume_get_shelf_and_blade,
                          self.context, 2)

    @attr(kind='small')
    def test_volume_get_iscsi_target_num(self):
        # setup
        self.db.api.iscsi_target_create_safe(self.context, {'volume_id':1, 'target_num':1})
        # test and assert
    ...
    def test_volume_get_iscsi_target_num_database_not_found(self):
        ...
        self.db.api.iscsi_target_create_safe(self.context, {'volume_id':1, 'target_num':1})
        # test and assert
        self.assertRaises(exception.ISCSITargetNotFoundForVolume, self.db.api.volume_get_iscsi_target_num,
                          self.context, 2)
    ...
    def test_volume_update_database_not_found(self):
        ...
        self.assertRaises(exception.VolumeNotFound, self.db.volume_update,
    ...
    def test_volume_metadata_get_item(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        meta = self.db.api.volume_metadata_get_item(self.context, 1, 'type')
    ...
    def test_volume_metadata_get_item_database_not_found(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        self.assertRaises(exception.VolumeMetadataNotFound, self.db.api.volume_metadata_get_item,
    ...
    def test_volume_metadata_update(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        self.db.api.volume_metadata_update(self.context, 1, {'type':'test2'}, False)
        meta = self.db.api.volume_metadata_get(self.context, 1)
    ...
    def test_volume_metadata_update_with_delete(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        self.db.api.volume_metadata_update(self.context, 1, {'type':'test2'}, True)
        meta = self.db.api.volume_metadata_get(self.context, 1)
        self.assertEqual('test2', meta['type'])
    ...
    def test_volume_metadata_update_new_item(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        self.db.api.volume_metadata_update(self.context, 1, {'type2':'test2'}, False)
        meta = self.db.api.volume_metadata_get(self.context, 1)
        self.assertEqual('test', meta['type'])
    ...
    def test_volume_metadata_update_database_not_found(self):
        ...
        vol['metadata'] = {'type':'test'}
        self.db.api.volume_create(self.context, vol)
        self.assertRaises(exception.VolumeNotFound, self.db.api.volume_metadata_update,
    ...
    def test_snapshot_create_database_duplicate(self):
        ...
        self.db.api.snapshot_create(self.context, snap)
        self.assertRaises(exception.Duplicate, self.db.api.snapshot_create,
                          self.context, snap)
    ...
    def test_snapshot_destroy(self):
        ...
        self.assertRaises(exception.SnapshotNotFound, self.db.api.snapshot_get,
                          self.context, 1)
    ...
    def test_snapshot_update(self):
        ...
        self.db.api.snapshot_create(self.context, snap)
        self.db.api.snapshot_update(self.context, 1, {'status':'available', 'progress':'100%'})
        result = self.db.api.snapshot_get(self.context, 1)
    ...
    def test_snapshot_update_database_not_found(self):
        ...
        self.db.api.snapshot_create(self.context, snap)
        self.assertRaises(exception.SnapshotNotFound, self.db.api.snapshot_update,
                          self.context, 2, {'status':'available', 'progress':'100%'})
    ...
    def test_block_device_mapping_create(self):
        ...
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 1)
        result = results[0]
    ...
    def test_block_device_mapping_update(self):
        ...
        self.db.api.block_device_mapping_create(self.context, bdm)
        self.db.api.block_device_mapping_update(self.context, 1, {'device_name':'/dev/sdg'})
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 1)
        result = results[0]
        self.assertEqual(1, result.instance.id)
        self.assertEqual(False, result.delete_on_termination)
    ...
    def test_block_device_mapping_update_database_not_found(self):
        ...
        self.db.api.block_device_mapping_create(self.context, bdm)
        self.db.api.block_device_mapping_update(self.context, 2,
                                                          {'instance_id':2, 'device_name':'/dev/sdg'})
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 1)
        result = results[0]
        self.assertEqual('/dev/sdh', result.device_name)
    ...
    def test_block_device_mapping_update_or_create(self):
        """
        when update or create, If the virtual_name not specified then raise KeyError.
        """
        raise SkipTest("If the virtual_name not specified then raise KeyError.")
        self.db.api.instance_create(self.context, {'id':1})
        self.db.api.volume_create(self.context, {'id':1, 'size':'1g'})
        self.db.api.snapshot_create(self.context, {'id':1, 'volume_id':1})
        ...
        self.db.api.block_device_mapping_create(self.context, bdm)
        self.db.api.block_device_mapping_update_or_create(self.context,
                                                          {'instance_id':1, 'device_name':'/dev/sdg'})
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 2)
        result = results[0]
        self.assertEqual('/dev/sdg', result.device_name)
    ...
    def test_block_device_mapping_destroy_by_instance_and_volume(self):
        ...
        self.db.api.block_device_mapping_create(self.context, bdm)
        self.db.api.block_device_mapping_destroy_by_instance_and_volume(self.context, 1, 1)
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 1)
        self.assertEqual([], results)
    ...
    def test_block_device_mapping_destroy_by_instance_and_volume_database_not_found(self):
        ...
        self.db.api.block_device_mapping_create(self.context, bdm)
        self.db.api.block_device_mapping_destroy_by_instance_and_volume(self.context, 2, 2)
        results = self.db.api.block_device_mapping_get_all_by_instance(self.context, 1)
        self.assertTrue(len(results) > 0)
    ...
    def test_security_group_create_database_duplicate(self):
        ...
        self.db.api.security_group_create(self.context, group)
        self.assertRaises(exception.Duplicate, self.db.api.security_group_create,
                          self.context, group)
    ...
    def test_security_group_get_database_not_found(self):
        ...
        self.assertRaises(exception.SecurityGroupNotFound, self.db.api.security_group_get,
                          self.context, 1)
    ...
    def test_security_group_get_by_name(self):
        ...
        self.db.api.security_group_create(self.context, group)
        result = self.db.api.security_group_get_by_name(self.context, 'fake', 'default')
        self.assertEqual('default', result.name)
        self.assertEqual('test', result.description)
        self.assertEqual('fake', result.user_id)
        self.assertEqual('fake', result.project_id)
    ...
    def test_security_group_get_by_name_database_not_found(self):
        ...
        self.db.api.security_group_create(self.context, group)
        self.assertRaises(exception.SecurityGroupNotFoundForProject, self.db.api.security_group_get_by_name,
    ...
    def test_security_group_get_by_project(self):
        ...
        self.db.api.security_group_create(self.context, group)
        results = self.db.api.security_group_get_by_project(self.context, 'fake')
        result = results[0]
        self.assertEqual('default', result.name)
        self.assertEqual('test', result.description)
        self.assertEqual('fake', result.user_id)
    ...
    def test_security_group_get_by_project_database_not_found(self):
        ...
        self.db.api.security_group_create(self.context, group)
        result = self.db.api.security_group_get_by_project(self.context, 'fake2')
        self.assertEqual([], result)
    ...
    def test_security_group_exists(self):
        ...
        self.db.api.security_group_create(self.context, group)
        result = self.db.api.security_group_exists(self.context, 'fake', 'default')
        self.assertTrue(result)
    ...
    def test_security_group_exists_database_not_found(self):
        ...
        self.db.api.security_group_create(self.context, group)
        result = self.db.api.security_group_exists(self.context, 'fake', 'default2')
    ...
    def test_security_group_destroy(self):
        ...
        self.assertRaises(exception.SecurityGroupNotFound, self.db.api.security_group_get,
                          self.context, 1)
        self.assertRaises(exception.SecurityGroupNotFoundForRule, self.db.api.security_group_rule_get,
                          self.context, 1)
    ...
    def test_security_group_destroy_database_not_found(self):
        ...
        self.assertRaises(exception.SecurityGroupNotFound, self.db.api.security_group_destroy,
                          self.context, 2)
    ...
    def test_security_group_rule_create_database_duplicate(self):
        ...
        rule['cidr'] = '0.0.0.0'
        self.db.api.security_group_rule_create(self.context, rule)
        self.assertRaises(exception.Duplicate, self.db.api.security_group_rule_create,
                          self.context, rule)
    ...
    def test_security_group_rule_get_by_security_group(self):
        ...
        result = self.db.api.security_group_rule_get_by_security_group(self.context, 1)
    ...
    def test_security_group_rule_get_by_security_group_grantee(self):
        ...
        result = self.db.api.security_group_rule_get_by_security_group_grantee(self.context, 1)
        self.assertEqual('tcp', result[0].protocol)
        self.assertEqual(0, result[0].from_port)
        self.assertEqual(8080, result[0].to_port)
        self.assertEqual('0.0.0.0', result[0].cidr)
    ...
    def test_provider_fw_rule_create_database_duplicate(self):
        ...
        # test and assert
        self.db.api.provider_fw_rule_create(self.context, rule)
        self.assertRaises(exception.Duplicate, self.db.api.provider_fw_rule_create,
                          self.context, rule)
    ...
    def test_provider_fw_rule_get_all_by_cidr(self):
        ...
        # test and assert
        self.db.api.provider_fw_rule_create(self.context, rule)
        results = self.db.api.provider_fw_rule_get_all_by_cidr(self.context, '0.0.0.0')
        self.assertEqual('tcp', results[0].protocol)
        self.assertEqual(0, results[0].from_port)
        self.assertEqual(80, results[0].to_port)
        self.assertEqual('0.0.0.0', results[0].cidr)
    ...
    def test_provider_fw_rule_get_all_by_cidr_database_not_found(self):
        ...
        # test and assert
        self.db.api.provider_fw_rule_create(self.context, rule)
        results = self.db.api.provider_fw_rule_get_all_by_cidr(self.context, '10.1.0.0')
        self.assertEqual([], results)
    ...
    def test_user_create_database_duplicate(self):
        ...
        user['is_admin'] = True
        # test and assert
        self.assertRaises(exception.Duplicate, self.db.api.user_create,
                          self.context, user)
    ...
    def test_user_get_database_not_found(self):
        ...
        # test and assert
        self.db.api.user_create(self.context, user)
        self.assertRaises(exception.UserNotFound, self.db.api.user_get,
                          self.context, 2)
    ...
    def test_user_get_by_access_key_database_not_found(self):
        ...
        # test and assert
        self.db.api.user_create(self.context, user)
        self.assertRaises(exception.AccessKeyNotFound, self.db.api.user_get_by_access_key,
    ...
    def test_user_delete_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.UserNotFound, self.db.api.user_delete,
                          self.context, 2)
    ...
    def test_user_add_role_database_duplicate(self):
        ...
        # test and assert
        self.assertRaises(exception.Duplicate, self.db.user_add_role,
    ...
    def test_user_add_project_role_database_duplicate(self):
        ...
        # test and assert
        self.assertRaises(exception.Duplicate, self.db.user_add_project_role,
    ...
    def test_user_update_database_not_found(self):
        ...
        # test and assert
        self.db.api.user_create(self.context, user)
        self.assertRaises(exception.UserNotFound, self.db.api.user_update,
    ...
    def test_project_create_database_duplicate(self):
        ...
        # test and assert
        self.assertRaises(exception.Duplicate, self.db.api.project_create,
    ...
    def test_project_add_member_user_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.UserNotFound, self.db.api.project_add_member,
                          self.context, 1, 2)
    ...
    def test_project_add_member_project_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.ProjectNotFound, self.db.api.project_add_member,
                          self.context, 2, 1)
    ...
    def test_project_get_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.ProjectNotFound, self.db.api.project_get,
                          self.context, 2)
    ...
    def test_project_get_by_user_user_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.UserNotFound, self.db.api.project_get_by_user,
                          self.context, 2)
    ...
    def test_project_remove_member_user_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.UserNotFound, self.db.api.project_remove_member,
                          self.context, 1, 2)
    ...
    def test_project_remove_member_project_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.ProjectNotFound, self.db.api.project_remove_member,
                          self.context, 2, 1)
    ...
    def test_project_update_database_not_found(self):
        ...
        # test and assert
        self.assertRaises(exception.ProjectNotFound, self.db.api.project_update,
    ...
    def test_project_delete_database_not_found(self):
        ...
        self.db.api.user_add_project_role(self.context, 1, 1, 'admin')
        # test and assert
        self.assertRaises(exception.ProjectNotFound, self.db.api.project_delete,
                          self.context, 2)
    ...
    def test_console_pool_create_database_duplicate(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        self.assertRaises(exception.Duplicate, self.db.api.console_pool_create,
                          self.context, con)
    ...
    def test_console_pool_get_database_not_found(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        self.assertRaises(exception.ConsolePoolNotFound, self.db.api.console_pool_get,
                          self.context, 2)
    ...
    def test_console_pool_get_by_host_type(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        pool = self.db.api.console_pool_get_by_host_type(self.context, 'compute', 'localhost', 'vnc')
        self.assertEqual('localhost', pool.address)
        self.assertEqual('fake', pool.username)
        self.assertEqual('fake', pool.password)
        self.assertEqual('vnc', pool.console_type)
    ...
    def test_console_pool_get_by_host_type_database_not_found(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        self.assertRaises(exception.ConsolePoolNotFoundForHostType, self.db.api.console_pool_get_by_host_type,
    ...
    def test_console_pool_get_all_by_host_type(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        pools = self.db.api.console_pool_get_all_by_host_type(self.context, 'localhost', 'vnc')
        pool = pools[0]
        self.assertEqual('localhost', pool.address)
        self.assertEqual('fake', pool.username)
        self.assertEqual('fake', pool.password)
    ...
    def test_console_pool_get_all_by_host_type_database_not_found(self):
        ...
        self.db.api.console_pool_create(self.context, con)
        pools = self.db.api.console_pool_get_all_by_host_type(self.context, 'localhost', 'xcp')
    ...
    def test_console_create_database_duplicate(self):
        ...
        self.db.api.console_create(self.context, con)
        self.assertRaises(exception.Duplicate, self.db.api.console_create,
                          self.context, con)
    ...
    def test_console_delete(self):
        ...
        self.assertRaises(exception.ConsoleNotFound, self.db.api.console_get,
                          self.context, 1)
    ...
    def test_console_get_instance_database_not_found(self):
        ...
        self.db.api.console_create(self.context, con)
        self.assertRaises(exception.ConsoleNotFoundForInstance, self.db.api.console_get,
                          self.context, 1, 2)
    ...
    def test_instance_type_create_database_duplicate(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.Duplicate, self.db.api.instance_type_create,
                          self.context, values)
    ...
    def test_instance_type_get_all_with_inactive(self):
        ...
        self.db.api.instance_type_extra_specs_update_or_create(self.context,
                                                               100,
                                                               extra_specs)
    ...
    def test_instance_type_get_database_not_found(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.InstanceTypeNotFound, self.db.api.instance_type_get,
                          self.context, 101)
    ...
    def test_instance_type_get_by_name_database_not_found(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.InstanceTypeNotFound, self.db.api.instance_type_get_by_name,
    ...
    def test_instance_type_get_by_flavor_id_database_not_found(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.FlavorNotFound, self.db.api.instance_type_get_by_flavor_id,
                          self.context, 101)
    ...
    def test_instance_type_destroy_database_not_found(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.InstanceTypeNotFoundByName, self.db.api.instance_type_destroy,
                          self.context, 'not_found')
    ...
    def test_instance_type_purge_database_not_found(self):
        ...
        # test and assert
        self.db.api.instance_type_create(self.context, values)
        self.assertRaises(exception.InstanceTypeNotFoundByName, self.db.api.instance_type_purge,
                          self.context, 'not_found')
    ...
    def test_zone_create_database_duplicate(self):
        ...
        # test and assert
        self.db.api.zone_create(self.context, zone)
        self.assertRaises(exception.Duplicate, self.db.api.zone_create,
                          self.context, zone)
    ...
    def test_zone_update_database_not_found(self):
        ...
        # test and assert
        self.db.api.zone_create(self.context, zone)
        self.assertRaises(exception.ZoneNotFound, self.db.api.zone_update,
                          self.context, 2, {'name':'new_name'})
    ...
    def test_zone_delete(self):
        ...
        self.assertRaises(exception.ZoneNotFound, self.db.api.zone_get,
                          self.context, 1)
    ...
    def test_instance_metadata_get_database_not_found(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.assertRaises(exception.InstanceNotFound, self.db.api.instance_metadata_get,
                          self.context, 2)
    ...
    def test_instance_metadata_delete_database_not_found(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.assertRaises(exception.InstanceNotFound, self.db.api.instance_metadata_delete,
                          self.context, 2, 'type')
    ...
    def test_instance_metadata_delete_all_database_not_found(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.assertRaises(exception.InstanceNotFound, self.db.api.instance_metadata_delete_all,
                          self.context, 2)
    ...
    def test_instance_metadata_get_item(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        metadata = self.db.api.instance_metadata_get_item(self.context, 1, 'type')
    ...
    def test_instance_metadata_update(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.db.api.instance_metadata_update(self.context, 1, {'type':'new_type'}, False)
        metadata = self.db.api.instance_metadata_get(self.context, 1)
    ...
    def test_instance_metadata_update_with_delete(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.db.api.instance_metadata_update(self.context, 1, {'type':'new_type'}, True)
        metadata = self.db.api.instance_metadata_get(self.context, 1)
        self.assertEqual('new_type', metadata['type'])
    ...
    def test_instance_metadata_update_with_new_value(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.db.api.instance_metadata_update(self.context, 1, {'spec':'new_spec'}, False)
        metadata = self.db.api.instance_metadata_get(self.context, 1)
        self.assertEqual('test', metadata['type'])
    ...
    def test_instance_metadata_update_database_not_found(self):
        ...
        self.db.api.instance_create(self.context, i)
        # test and assert
        self.assertRaises(exception.InstanceNotFound, self.db.api.instance_metadata_update,
    ...
    def test_agent_build_create(self):
        ...
        result = self.db.api.agent_build_get_by_triple(self.context, 'kvm', 'linux', 'x86_64')
    ...
    def test_agent_build_create_database_duplicate(self):
        ...
        self.db.api.agent_build_create(self.context, ab)
        self.assertRaises(exception.Duplicate, self.db.api.agent_build_create,
                          self.context, ab)
    ...
    def test_agent_build_get_by_triple_database_not_found(self):
        ...
        self.db.api.agent_build_create(self.context, ab)
        result = self.db.api.agent_build_get_by_triple(self.context, 'kvm', 'windows', 'x86_64')
    ...
    def test_agent_build_update_database_not_found(self):
        ...
        should be raise error
        """
        raise SkipTest("No exception occured in invalid id specified, so raise AttributeError.")
        # setup
        ab = {}
        ab['id'] = 1
        ab['hypervisor'] = 'kvm'
    ...
    def test_instance_type_extra_specs_delete_database_not_found(self):
        ...
        self.db.api.instance_type_create(self.context, values)
        self.db.api.instance_type_extra_specs_delete(self.context, 100, 'unknow_key')
        result = self.db.api.instance_type_extra_specs_get(self.context, 100)
        self.assertEqual('value1', result['key1'])
    ...
    def test_instance_type_extra_specs_get_item(self):
        ...
        self.db.api.instance_type_create(self.context, values)
        result = self.db.api.instance_type_extra_specs_get_item(self.context, 100, 'key1')
    ...
    def test_instance_type_extra_specs_update_or_create(self):
        ...
        self.db.api.instance_type_create(self.context, values)
        self.db.api.instance_type_extra_specs_update_or_create(self.context, 100, {'key1':'value2'})
        result = self.db.api.instance_type_extra_specs_get(self.context, 100)
    ...
    def test_instance_type_extra_specs_update_or_create_append(self):
        ...
        self.db.api.instance_type_create(self.context, values)
        self.db.api.instance_type_extra_specs_update_or_create(self.context, 100, {'key2':'value2'})
        result = self.db.api.instance_type_extra_specs_get(self.context, 100)
        self.assertEqual('value1', result['key1'])
    ...
    def test_volume_type_create_database_duplicate(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.assertRaises(exception.DBError, self.db.api.volume_type_create,
                          self.context, values)
    ...
    def test_volume_type_get_database_not_found(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.assertRaises(exception.VolumeTypeNotFound, self.db.api.volume_type_get,
                          self.context, 2)
    ...
    def test_volume_type_get_by_name_database_not_found(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.assertRaises(exception.VolumeTypeNotFoundByName, self.db.api.volume_type_get_by_name,
                          self.context, 'not_found')
    ...
    def test_volume_type_destroy_database_not_found(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.assertRaises(exception.VolumeTypeNotFoundByName, self.db.api.volume_type_destroy,
                          self.context, 'not_found')
    ...
    def test_volume_type_purge_database_not_found(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.assertRaises(exception.VolumeTypeNotFoundByName, self.db.api.volume_type_purge,
                          self.context, 'not_found')
    ...
    def test_volume_type_extra_specs_updaye_or_create(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.db.api.volume_type_extra_specs_update_or_create(self.context, 1, {'key1':'new_value'})
        result = self.db.api.volume_type_extra_specs_get(self.context, 1)
    ...
    def test_volume_type_extra_specs_updaye_or_create_append(self):
        ...
        self.db.api.volume_type_create(self.context, values)
        self.db.api.volume_type_extra_specs_update_or_create(self.context, 1, {'key2':'new_value'})
        result = self.db.api.volume_type_extra_specs_get(self.context, 1)
        self.assertEqual('value1', result['key1'])
    ...
    def test_vsa_create_database_duplicate(self):
        ...
        self.db.api.vsa_create(self.context, vsa)
        self.assertRaises(exception.Duplicate, self.db.api.vsa_create,
                          self.context, vsa)
    ...
    def test_vsa_update_database_not_found(self):
        ...
        self.db.api.vsa_create(self.context, vsa)
        self.assertRaises(exception.VirtualStorageArrayNotFound, self.db.api.vsa_update,
    ...
    def test_vsa_destroy(self):
        ...
        self.assertRaises(exception.VirtualStorageArrayNotFound, self.db.api.vsa_get,
                          self.context, 1)
