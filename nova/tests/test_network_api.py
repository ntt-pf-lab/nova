...
class APITestCase(test.TestCase):
    ...
    def test_release_floating_ip(self):
        ...
        def cast(topic, content):
            ...
            self.assertEqual(floating_ip_ref['address'], content['args']['floating_address'])

        self.cast = cast
        
        address = '192.168.0.1'
        affect_auto_assigned = True
        self.api.release_floating_ip(self.context, address, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_release_floating_ip_parameter_fixed_ip_is_not_none(self):
        ...
        self.assertRaises(exception.ApiError,
                          ...
                          self.context, address, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_release_floating_ip_parameter_not_affect_auto_assigned_and_auto_assigned(self):
        ...
        ref = self.api.release_floating_ip(self.context, address, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_associate_floating_ip(self):
        ...
        def cast(topic, content):
            ...
            self.assertEqual(floating_ip_ref['address'], content['args']['floating_address'])
            self.assertEqual(fixed_ip['address'], content['args']['fixed_address'])
        ...
        affect_auto_assigned = True
        self.api.associate_floating_ip(self.context, floating_ip, fixed_ip, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_associate_floating_ip_parameter_fixed_ip_isinstance_of_basestring(self):
        ...
        def cast(topic, content):
            ...
            self.assertEqual('associate_floating_ip', content['method'])
            self.assertEqual(floating_ip_ref['address'], content['args']['floating_address'])
            self.assertEqual(fixed_ip_ref['address'], content['args']['fixed_address'])
    ...
    def test_associate_floating_ip_parameter_not_affect_auto_assigned_and_auto_assigned(self):
        ...
        fixed_ip = dict(fixed_ips[0])
        affect_auto_assigned = False
        ref = self.api.associate_floating_ip(self.context, floating_ip, fixed_ip, affect_auto_assigned=affect_auto_assigned)
        self.assertEqual(None, ref)
    ...
    def test_associate_floating_ip_database_floating_ip_project_id_is_none(self):
        ...
        self.assertRaises(exception.ApiError,
                          ...
                          self.context, floating_ip, fixed_ip, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_disassociate_floating_ip(self):
        ...
        address = '192.168.0.1'
        affect_auto_assigned = True
        self.api.disassociate_floating_ip(self.context, address, affect_auto_assigned=affect_auto_assigned)
    ...
    def test_allocate_for_instance(self):
        ...
        def call(topic, content):
            ...
            self.assertEqual(instance['instance_type_id'], args['instance_type_id'])
            return network_info
    ...
    def test_add_fixed_ip_to_instance(self):
        ...
        host = 'testhost'
        network_id = 1
        self.api.add_fixed_ip_to_instance(self.context, instance_id, host, network_id)
    ...
    def test_remove_fixed_ip_from_instance(self):
        ...
        def cast(topic, content):
            self.assertEqual(FLAGS.network_topic, topic)
            self.assertEqual('remove_fixed_ip_from_instance', content['method'])
            args = content['args']
            self.assertEqual(instance_id, args['instance_id'])
        ...
        instance_id = 1
        address = '10.0.0.1'
        self.api.remove_fixed_ip_from_instance(self.context, instance_id, address)
